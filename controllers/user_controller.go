...
func CreateUser(c *gin.Context) {
	...
	if len(results) == 0 {
		...
		c.JSON(http.StatusUnauthorized, responses.UserResponse{Status: http.StatusUnauthorized, Message: "error", Data: map[string]interface{}{"data": "Name exist. Please choose name another"}})
		return
	}
